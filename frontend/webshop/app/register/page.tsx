            ...
            <main>
                <div className="container mx-auto px-4 py-8 text-center flex flex-col my-10 h-auto w-100 rounded-3xl" style={{ backgroundColor: "#5372F0" }}>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col items-center w-full">
                        ...
                        <div className="relative w-full mt-5">
                            <FontAwesomeIcon icon={faEnvelope} className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-white/80" />
                            <input type="email" name="email" placeholder="Email" id="email" required className="rounded-lg h-10 w-full border border-transparent pl-10 focus:outline-none focus:border-[#8FA7FF]" style={{ backgroundColor: "#4965D4" }} />
                        </div>
                        <div className="relative w-full mt-5">
